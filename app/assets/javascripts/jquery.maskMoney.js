...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="1429323" name="octolytics-actor-id" /><meta content="HenriqueLacerda" name="octolytics-actor-login" /><meta content="af56930866e8505b84898bd618122924ae34bb9990b37c3d3c7e63f76adb04ae" name="octolytics-actor-hash" />
...
<meta content="QZAiE4TjsjHDkCvHF7atLoRHmBwhhBsVY7rzaVOwfos=" name="csrf-token" />
...
<input type="text" data-hotkey="/ s" name="q" id="js-command-bar-field" placeholder="Search or type a command" tabindex="1" autocapitalize="off"
  ...
  <ul id="user-links">
    <li>
      <a href="/HenriqueLacerda" class="name">
        <img height="20" src="https://2.gravatar.com/avatar/4c6d305735058e823deaa71ceac42e2b?d=https%3A%2F%2Fidenticons.github.com%2Fb6a7f38381bcbcfc67fcfc29329c05c3.png&amp;s=140" width="20" /> HenriqueLacerda
      </a>
    </li>
...
<ul class="dropdown-menu">
  ...
  <li>
    ...
    <li>
      <a href="/plentz/jquery-maskmoney/issues/new"><span class="octicon octicon-issue-opened"></span> New issue</a>
    </li>
</ul>
...
<ul class="pagehead-actions">
    ...
    <li class="subscription">
      <form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="authenticity_token" type="hidden" value="QZAiE4TjsjHDkCvHF7atLoRHmBwhhBsVY7rzaVOwfos=" /></div>  <input id="repository_id" name="repository_id" type="hidden" value="354843" />
...
<div class="js-toggler-container js-social-container starring-container ">
  <a href="/plentz/jquery-maskmoney/unstar" class="minibutton with-count js-toggler-target star-button starred upwards" title="Unstar this repo" data-remote="true" data-method="post" rel="nofollow">
    <span class="octicon octicon-star-delete"></span><span class="text">Unstar</span>
  </a>
  <a href="/plentz/jquery-maskmoney/star" class="minibutton with-count js-toggler-target star-button unstarred upwards" title="Star this repo" data-remote="true" data-method="post" rel="nofollow">
    <span class="octicon octicon-star"></span><span class="text">Star</span>
  </a>
  <a class="social-count js-social-count" href="/plentz/jquery-maskmoney/stargazers">259</a>
</div>
        ...
        <li>
          <a href="/plentz/jquery-maskmoney/fork" class="minibutton with-count js-toggler-target fork-button lighter upwards" title="Fork this repo" rel="facebox nofollow">
            <span class="octicon octicon-git-branch-create"></span><span class="text">Fork</span>
          </a>
          <a href="/plentz/jquery-maskmoney/network" class="social-count">153</a>
        </li>
    ...
    <ul class="repo-menu">
      ...
      <li class="tooltipped leftwards" title="Pull Requests"><a href="/plentz/jquery-maskmoney/pulls" aria-label="Pull Requests" class="js-selected-navigation-item js-disable-pjax" data-gotokey="p" data-selected-links="repo_pulls /plentz/jquery-maskmoney/pulls">
        ...
        <li class="tooltipped leftwards" title="Wiki">
          <a href="/plentz/jquery-maskmoney/wiki" aria-label="Wiki" class="js-selected-navigation-item " data-pjax="true" data-selected-links="repo_wiki /plentz/jquery-maskmoney/wiki">
...
<div class="clone-url "
  ...
  <input type="text" class="clone js-url-field"
         value="git@github.com:plentz/jquery-maskmoney.git" readonly="readonly">

  <span class="js-zeroclipboard url-box-clippy minibutton zeroclipboard-button" data-clipboard-text="git@github.com:plentz/jquery-maskmoney.git" data-copied-hint="copied!" title="copy to clipboard"><span class="octicon octicon-clippy"></span></span>
</div>
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v1.4.1/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.4.1" data-skip-pjax="true" rel="nofollow" title="v1.4.1">v1.4.1</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v1.4.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.4.0" data-skip-pjax="true" rel="nofollow" title="v1.4.0">v1.4.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v1.3.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.3.0" data-skip-pjax="true" rel="nofollow" title="v1.3.0">v1.3.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v1.2.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.2.0" data-skip-pjax="true" rel="nofollow" title="v1.2.0">v1.2.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v1.1.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.1.0" data-skip-pjax="true" rel="nofollow" title="v1.1.0">v1.1.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v1.0.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v1.0.0" data-skip-pjax="true" rel="nofollow" title="v1.0.0">v1.0.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v0.9.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v0.9.0" data-skip-pjax="true" rel="nofollow" title="v0.9.0">v0.9.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v0.5.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v0.5.0" data-skip-pjax="true" rel="nofollow" title="v0.5.0">v0.5.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v0.4.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v0.4.0" data-skip-pjax="true" rel="nofollow" title="v0.4.0">v0.4.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v0.3.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v0.3.0" data-skip-pjax="true" rel="nofollow" title="v0.3.0">v0.3.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/v0.1.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="v0.1.0" data-skip-pjax="true" rel="nofollow" title="v0.1.0">v0.1.0</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/2.1.2/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="2.1.2" data-skip-pjax="true" rel="nofollow" title="2.1.2">2.1.2</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/2.0.1/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="2.0.1" data-skip-pjax="true" rel="nofollow" title="2.0.1">2.0.1</a>
            </div> <!-- /.select-menu-item -->
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/plentz/jquery-maskmoney/tree/2.0.0/jquery.maskMoney.js" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="2.0.0" data-skip-pjax="true" rel="nofollow" title="2.0.0">2.0.0</a>
            </div> <!-- /.select-menu-item -->
        </div>
      ...
      <div class="actions">
        <div class="button-group">
                <a class="minibutton tooltipped leftwards"
                   ...
                   href="/plentz/jquery-maskmoney/edit/master/jquery.maskMoney.js"
          ...
          <a href="/plentz/jquery-maskmoney/commits/master/jquery.maskMoney.js" class="button minibutton " rel="nofollow">History</a>
            ...
            <a class="minibutton danger empty-icon tooltipped downwards"
               href="/plentz/jquery-maskmoney/delete/master/jquery.maskMoney.js"
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.06249s from github-fe121-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
