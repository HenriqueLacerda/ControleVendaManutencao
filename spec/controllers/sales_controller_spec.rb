...
describe SalesController do
  ...
  let(:valid_attributes) { { "data" => "2013-09-01" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sale as @sale" do
        ...
        post :create, {:sale => { "data" => "invalid value" }}, valid_session
        assigns(:sale).should be_a_new(Sale)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sale" do
        ...
        Sale.any_instance.should_receive(:update_attributes).with({ "data" => "2013-09-01" })
        put :update, {:id => sale.to_param, :sale => { "data" => "2013-09-01" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sale as @sale" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sale.any_instance.stub(:save).and_return(false)
        put :update, {:id => sale.to_param, :sale => { "data" => "invalid value" }}, valid_session
        assigns(:sale).should eq(sale)
      end
